    ...
    <section id="pricing" class="section price-plan-area bg-grey overflow-hidden ptb_100">
      <div class="container">
            ...
            <div class="row price-plan-wrapper">
              <div class="col-12 col-md-6">
                <div class="single-price-plan color-1 bg-hover hover-top text-center p-5">
                  ...
                  <div class="plan-price pb-2 pb-sm-3"><span class="color-primary fw-7">$</span> <span class="h1 fw-7">49</span> <sub class="validity text-muted fw-5">/mo</sub></div>
                  ...
                  <div class="plan-button"><a href="#" class="btn btn-bordered mt-3">Get Started</a></div>
                </div>
              </div>
              <div class="col-12 col-md-6 mt-4 mt-md-0">
                <div class="single-price-plan color-2 bg-hover active hover-top text-center p-5">
                  <div class="plan-title mb-2 mb-sm-3">
                    <h3 class="mb-2">
                      Pro <sup><span class="badge badge-pill badge-warning ml-2">Save 20%</span></sup>
                    </h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet, nemo.</p>
                  </div>
                  <div class="plan-price pb-2 pb-sm-3"><span class="color-primary fw-7">$</span> <span class="h1 fw-7">129</span> <sub class="validity text-muted fw-5">/mo</sub></div>
                  <div class="plan-description">
                    <ul class="plan-features">
        ...
        <div class="row justify-content-center pt-5">
          <p class="pt-4 fw-5">
            Not sure what to choose? <a class="service-btn" href="#"><strong>Contact Us</strong></a>
          </p>
        </div>
      </div>
    </section>
          ...
          <div class="client-reviews owl-carousel">
            <div class="single-review p-5">
              <div class="review-content">
                ...
                <div class="quot-icon"><img class="avatar-sm" src="../../../static/assets/img/quote.png" alt="" /></div>
              </div>
              <div class="reviewer media mt-3">
                <div class="reviewer-thumb"><img class="avatar-lg radius-100" src="../../../static/assets/img/avatar/avatar-1.png" alt="" /></div>
            ...
            <div class="single-review p-5">
              ...
              <div class="reviewer media mt-3">
                <div class="reviewer-thumb"><img class="avatar-lg radius-100" src="../../../static/assets/img/avatar/avatar-2.png" alt="" /></div>
                <div class="reviewer-meta media-body align-self-center ml-4">
            ...
            <div class="single-review p-5">
              ...
              <div class="reviewer media mt-3">
                <div class="reviewer-thumb"><img class="avatar-lg radius-100" src="../../../static/assets/img/avatar/avatar-3.png" alt="" /></div>
                <div class="reviewer-meta media-body align-self-center ml-4">
