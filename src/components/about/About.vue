        ...
        <div class="row justify-content-between">
          ...
          <div class="col-12 col-lg-6">
            ...
            <div class="service-thumb mx-auto pt-4 pt-lg-0">
              <img src="../../../static/assets/img/content/content_thumb.png" alt="">
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="profile-inner">
                ...
                <div class="profile-circle circle-lg">
                  <span class="profile-icon icon-1">
                    <img class="icon-1-img" src="../../../static/assets/img/content/profile-icons/profile_icon_1.svg" alt="" />
                  </span>
                  <span class="profile-icon icon-2">
                    <img class="icon-2-img" src="../../../static/assets/img/content/profile-icons/profile_icon_2.svg" alt="" />
                  </span>
                  <span class="profile-icon icon-3">
                    <img class="icon-3-img" src="../../../static/assets/img/content/profile-icons/profile_icon_1.svg" alt="" />
                  </span>
                  <span class="profile-icon icon-4">
                    <img class="icon-4-img" src="../../../static/assets/img/content/profile-icons/profile_icon_2.svg" alt="" />
                  </span>
                </div>

                <div class="profile-circle circle-md">
                  <span class="profile-icon icon-5">
                    <img class="icon-5-img" src="../../../static/assets/img/content/profile-icons/profile_icon_3.svg" alt="" />
                  </span>
                  <span class="profile-icon icon-6">
                    <img class="icon-6-img" src="../../../static/assets/img/content/profile-icons/profile_icon_3.svg" alt="" />
                  </span>
                  <span class="profile-icon icon-7">
                    <img class="icon-7-img" src="../../../static/assets/img/content/profile-icons/profile_icon_3.svg" alt="" />
                  </span>
                </div>
                ...
                <div class="profile-circle circle-sm">
                  <span class="profile-icon icon-8">
                    <img class="icon-8-img" src="../../../static/assets/img/content/profile-icons/profile_icon_4.svg" alt="" />
                  </span>
                  <span class="profile-icon icon-9">
                    <img class="icon-9-img" src="../../../static/assets/img/content/profile-icons/profile_icon_4.svg" alt="" />
                  </span>
                </div>
              </div>
              <img class="folder-img" src="../../../static/assets/img/content/folders.png" alt="" />
            </div>
          </div>
          <div class="col-12 col-lg-6">
            <!-- Content Inner -->
